...
class posicion_bebidas:
    ...
    @classmethod
    def save(cls, data):
        query = "INSERT INTO "+ table_name +" ( nombre,pos1,pos2,pos3,pos4,pos5,pos6,pos7,pos8,pos9,pos10,pos11,pos12,pos13,pos14,pos15,pos16,pos17,pos18,pos19,pos20,pos21,pos22,pos23,pos24) VALUES ( %(nombre)s,%(pos1)s, %(pos2)s, %(pos3)s, %(pos4)s, %(pos5)s, %(pos6)s, %(pos7)s, %(pos8)s, %(pos9)s, %(pos10)s, %(pos11)s, %(pos12)s, %(pos13)s, %(pos14)s, %(pos15)s, %(pos16)s, %(pos17)s, %(pos18)s, %(pos19)s, %(pos20)s, %(pos21)s, %(pos22)s, %(pos23)s, %(pos24)s);"
